...
const displayForm = () => {
  ...
  domString += '<input type="text" class="form-control" id="form-text" placeholder="Text here">';
  domString += '</div>';
  domString += '<button type="submit" id="really-nice-form-button" class="btn btn-primary">Submit</button>';
  domString += '</form>';
